...
boxes = [
    ...
    aligned_box(left=3850, right=4120, lower=360, upper=1040, target=(4100, 400)),
    aligned_box(left=110, right=4120, lower=260, upper=540, target=(255, 270)),
    aligned_box(left=150, right=400, lower=-1980, upper=540, target=(255, -1900)),
    aligned_box(left=-1550, right=400, lower=-1980, upper=-1720, target=(-825, -1800)),
